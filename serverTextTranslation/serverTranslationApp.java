    ...
    private void startServer() {
        ...
        try {
            ...
            while (true) {
                ...
                String log = "Text received from client: " + text 
                		+ " | Translated: " + translatedText;
                appendToLog(log);

                DataOutputStream dos = new DataOutputStream(clientSocket
                		.getOutputStream());
                ...
                RequestDetails requestDetails = new RequestDetails(text, 
                		translatedText);
